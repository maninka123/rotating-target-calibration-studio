...
export const SENSOR_LIBRARY: SensorDefinition[] = [
  ...
  { ...defaults, id: 'livox-avia', name: 'Livox Avia', architecture: 'prism', standOffM: 1, horizontalFovDeg: 70.4, verticalFovDeg: 77.2, prismRateAHz: 173.3, prismRateBHz: -211.7, wedgeADeg: 5.5, wedgeBDeg: 7, sampleRateHz: 240000, timestampConvention: 'window-start' },
